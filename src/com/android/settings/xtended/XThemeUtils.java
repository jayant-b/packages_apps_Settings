...
import static com.android.settings.xtended.ScheduleFragment.PREF_THEME_SCHEDULED_END_THEME;
import static com.android.settings.xtended.ScheduleFragment.PREF_THEME_SCHEDULED_END_THEME_VALUE;
import static com.android.settings.xtended.ScheduleFragment.PREF_THEME_SCHEDULED_END_TIME;
import static com.android.settings.xtended.ScheduleFragment.PREF_THEME_SCHEDULED_REPEAT_DAILY;
import static com.android.settings.xtended.ScheduleFragment.PREF_THEME_SCHEDULED_START_THEME;
import static com.android.settings.xtended.ScheduleFragment.PREF_THEME_SCHEDULED_START_THEME_VALUE;
import static com.android.settings.xtended.ScheduleFragment.PREF_THEME_SCHEDULED_START_TIME;
import static com.android.settings.xtended.ScheduleFragment.PREF_ALARM_START_TIME;
import static com.android.settings.xtended.ScheduleFragment.PREF_ALARM_END_TIME;
...
import com.android.settings.xtended.ThemesEndReceiver;
import com.android.settings.xtended.ThemesStartReceiver;
        ...
        if (scheduledStartThemeSummary != null) {
            switch (scheduledStartThemeSummary) {
                ...
                case "5":
                    ...
                    break;
                case "6":
                    scheduledStartThemeSummary = context.getString(R.string.theme_type_du_pitchblack);
                    break;
            }
        }
        ...
        if (scheduledEndThemeSummary != null) {
            switch (scheduledEndThemeSummary) {
                ...
                case "5":
                    ...
                    break;
                case "6":
                    scheduledEndThemeSummary = context.getString(R.string.theme_type_du_pitchblack);
                    break;
            }
        }
